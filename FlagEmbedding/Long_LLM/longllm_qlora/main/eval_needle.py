...
class Args(ModelArgs):
    haystack_path: str = field(
        default="/root/mountpoint/yumu/FlagEmbedding/Long_LLM/longllm_qlora/data/long-llm/needle/PaulGrahamEssays",
    ...
    def __post_init__(self):
        super().__post_init__()
        # self.haystack_path = "/root/mountpoint/yumu/FlagEmbedding/Long_LLM/longllm_qlora/data/long-llm/needle/PaulGrahamEssays/"
        self.resolve_path(self.haystack_path)
